...
theta1 = math.acos((radius1**2 - radius2**2 + distance(x1, y1, x2, y2)**2) / (2 * radius1 * distance(x1, y1, x2, y2)))
...
theta2 = math.acos((radius2**2 - radius3**2 + distance(x2, y2, x3, y3)**2) / (2 * radius2 * distance(x2, y2, x3, y3)))
...
theta3 = math.acos((radius3**2 - radius4**2 + distance(x3, y3, x4, y4)**2) / (2 * radius3 * distance(x3, y3, x4, y4)))
...
theta4 = math.acos((radius4**2 - radius1**2 + distance(x4, y4, x1, y1)**2) / (2 * radius4 * distance(x4, y4, x1, y1)))
...
# t.setheading(math.degrees(theta1) - 90)
# # Рисуем четверть окружности в другую сторону
# t.circle(radius1, -900)

# # Перемещаем черепаху в точку пересечения 1 и 2 окружностей
# t.penup()
# t.setposition(x_intersect_2_3, y_intersect_2_3)
# t.pendown()
# # Устанавливаем цвет пера в красный
# t.color("red")
# # Направляем черепаху в нужное направление (против часовой стрелки)
# t.setheading(math.degrees(theta1))
# # Рисуем четверть окружности в другую сторону
# t.circle(radius2, -900)

# # Перемещаем черепаху в точку пересечения 1 и 2 окружностей
# t.penup()
# t.setposition(x_intersect_3_4, y_intersect_3_4)
# t.pendown()
# # Устанавливаем цвет пера в красный
# t.color("red")
# # Направляем черепаху в нужное направление (против часовой стрелки)
# t.setheading(math.degrees(theta1 - 11))
# # Рисуем четверть окружности в другую сторону
# t.circle(radius3, - 900)

# # Перемещаем черепаху в точку пересечения 1 и 2 окружностей
# t.penup()
# t.setposition(x_intersect_4_1, y_intersect_4_1)
# t.pendown()
# # Устанавливаем цвет пера в красный
# t.color("red")
# # Направляем черепаху в нужное направление (против часовой стрелки)
# t.setheading(math.degrees(theta1 -360 ))
# # Рисуем четверть окружности в другую сторону
# t.circle(radius4, - 900)
...
red_figure_area = math.pi * radius4 ** 2

print("Площадь красной фигуры:", red_figure_area)
